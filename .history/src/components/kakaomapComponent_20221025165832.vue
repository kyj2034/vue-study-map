...
// 다각형에 click 이벤트를 등록하고 이벤트가 발생하면 다각형의 이름과 면적을 인포윈도우에 표시합니다
    ...
    imageMarkCstOveray(){
      ...
      let imageSrc = "require(`@assets/images/markerimg.png`)",
      imageSize = new kakao.maps.Size(64,69),
      imageOption = { offset: new kakao.maps.Point(27,69)};

      let markerImage = new kakao.map.MarkerImage(imageSrc, imageSize, imageOption),
        markerPosition = new kakao.map.LatLng(37.54699, 127.09598); // 마커가 표시될 위치입니다.
